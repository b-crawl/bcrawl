...
static const char *weapon_brands_terse[] =
{
    ...
    "evade", "confuse",
#endif
    "penet", "reap", "petrify", "buggy-num", "acid",
#if TAG_MAJOR_VERSION > 34
    "confuse",
#endif
    "debug",
...
static const char *weapon_brands_verbose[] =
{
    ...
    "evasion", "confusion",
#endif
    "penetration", "reaping", "petrification", "buggy-num", "acid",
#if TAG_MAJOR_VERSION > 34
    "confusion",
#endif
    "debug",
...
const char* armour_ego_name(const item_def& item, bool terse)
{
    if (!terse)
    {
        ...
        case SPARM_MANA_REGEN:        return "magic recovery";
#if TAG_MAJOR_VERSION == 34
    ...
    else
    {
        ...
        case SPARM_MANA_REGEN:        return "RegenMP";
#if TAG_MAJOR_VERSION == 34
...
static const char* _book_type_name(int booktype)
{
    ...
    case BOOK_REBUKES:                return "Rebukes";
...
bool is_useless_item(const item_def &item, bool temp)
{
    ...
    case OBJ_JEWELLERY:
        ...
        case AMU_THE_GOURMAND:
            return you.get_mutation_level(MUT_HERBIVOROUS) > 0
