...
static const species_skill_aptitude species_skill_aptitudes[] =
{
    ...
    APT(SP_HUMAN,           SK_SHORT_BLADES,    1),
    APT(SP_HUMAN,           SK_LONG_BLADES,     1),
    APT(SP_HUMAN,           SK_AXES,            1),
    APT(SP_HUMAN,           SK_MACES_FLAILS,    1),
    APT(SP_HUMAN,           SK_POLEARMS,        1),
    APT(SP_HUMAN,           SK_STAVES,          1),
    APT(SP_HUMAN,           SK_SLINGS,          1),
    APT(SP_HUMAN,           SK_BOWS,            1),
    APT(SP_HUMAN,           SK_CROSSBOWS,       1),
    APT(SP_HUMAN,           SK_THROWING,        1),
    APT(SP_HUMAN,           SK_ARMOUR,          1),
    APT(SP_HUMAN,           SK_DODGING,         1),
    APT(SP_HUMAN,           SK_STEALTH,         2),
#if TAG_MAJOR_VERSION == 34
    APT(SP_HUMAN,           SK_STABBING,      UNUSABLE_SKILL),
#endif
    APT(SP_HUMAN,           SK_SHIELDS,         1),
#if TAG_MAJOR_VERSION == 34
    APT(SP_HUMAN,           SK_TRAPS,         UNUSABLE_SKILL),
#endif
    APT(SP_HUMAN,           SK_UNARMED_COMBAT,  1),
    APT(SP_HUMAN,           SK_SPELLCASTING,   -1),
    APT(SP_HUMAN,           SK_CONJURATIONS,    1),
    APT(SP_HUMAN,           SK_HEXES,           1),
    APT(SP_HUMAN,           SK_CHARMS,          1),
    APT(SP_HUMAN,           SK_SUMMONINGS,      1),
    APT(SP_HUMAN,           SK_NECROMANCY,      1),
    APT(SP_HUMAN,           SK_TRANSLOCATIONS,  1),
    APT(SP_HUMAN,           SK_TRANSMUTATIONS,  1),
    APT(SP_HUMAN,           SK_FIRE_MAGIC,      1),
    APT(SP_HUMAN,           SK_ICE_MAGIC,       1),
    APT(SP_HUMAN,           SK_AIR_MAGIC,       1),
    APT(SP_HUMAN,           SK_EARTH_MAGIC,     1),
    APT(SP_HUMAN,           SK_POISON_MAGIC,    1),
    APT(SP_HUMAN,           SK_INVOCATIONS,     2),
    APT(SP_HUMAN,           SK_EVOCATIONS,      2),
    ...
    APT(SP_HIGH_ELF,        SK_STAVES,          2),
    APT(SP_HIGH_ELF,        SK_SLINGS,          0),
    APT(SP_HIGH_ELF,        SK_BOWS,            2),
    APT(SP_HIGH_ELF,        SK_CROSSBOWS,      -2),
    APT(SP_HIGH_ELF,        SK_THROWING,       -3),
    APT(SP_HIGH_ELF,        SK_ARMOUR,          0),
    APT(SP_HIGH_ELF,        SK_DODGING,         1),
    APT(SP_HIGH_ELF,        SK_STEALTH,         2),
    APT(SP_HIGH_ELF,        SK_STABBING,      UNUSABLE_SKILL),
    APT(SP_HIGH_ELF,        SK_SHIELDS,         0),
    APT(SP_HIGH_ELF,        SK_TRAPS,         UNUSABLE_SKILL),
    APT(SP_HIGH_ELF,        SK_UNARMED_COMBAT,  1),
    APT(SP_HIGH_ELF,        SK_SPELLCASTING,    1),
    APT(SP_HIGH_ELF,        SK_CONJURATIONS,    1),
    APT(SP_HIGH_ELF,        SK_HEXES,           1),
    APT(SP_HIGH_ELF,        SK_CHARMS,          1),
    APT(SP_HIGH_ELF,        SK_SUMMONINGS,      1),
    APT(SP_HIGH_ELF,        SK_NECROMANCY,      1),
    APT(SP_HIGH_ELF,        SK_TRANSLOCATIONS,  1),
    APT(SP_HIGH_ELF,        SK_TRANSMUTATIONS,  1),
    APT(SP_HIGH_ELF,        SK_FIRE_MAGIC,      1),
    APT(SP_HIGH_ELF,        SK_ICE_MAGIC,       1),
    APT(SP_HIGH_ELF,        SK_AIR_MAGIC,       1),
    APT(SP_HIGH_ELF,        SK_EARTH_MAGIC,     1),
    APT(SP_HIGH_ELF,        SK_POISON_MAGIC,    1),
    APT(SP_HIGH_ELF,        SK_INVOCATIONS,     2),
    ...
    APT(SP_TROLL,           SK_MACES_FLAILS,    0),
    ...
    APT(SP_TROLL,           SK_ARMOUR,         UNUSABLE_SKILL),
    ...
    APT(SP_TROLL,           SK_SPELLCASTING,   -3),
    APT(SP_TROLL,           SK_CONJURATIONS,   -3),
    APT(SP_TROLL,           SK_HEXES,           0),
    APT(SP_TROLL,           SK_CHARMS,         -1),
    APT(SP_TROLL,           SK_SUMMONINGS,     -3),
    APT(SP_TROLL,           SK_NECROMANCY,      0),
    APT(SP_TROLL,           SK_TRANSLOCATIONS, -3),
    APT(SP_TROLL,           SK_TRANSMUTATIONS, -4),
    APT(SP_TROLL,           SK_FIRE_MAGIC,     -3),
    APT(SP_TROLL,           SK_ICE_MAGIC,      -3),
    APT(SP_TROLL,           SK_AIR_MAGIC,      -4),
    APT(SP_TROLL,           SK_EARTH_MAGIC,     0),
    APT(SP_TROLL,           SK_POISON_MAGIC,    0),
    APT(SP_TROLL,           SK_INVOCATIONS,     0),
    ...
    APT(SP_CENTAUR,         SK_STAVES,         -2),
    APT(SP_CENTAUR,         SK_SLINGS,          1),
    APT(SP_CENTAUR,         SK_BOWS,            3),
    APT(SP_CENTAUR,         SK_CROSSBOWS,       2),
    APT(SP_CENTAUR,         SK_THROWING,        1),
    APT(SP_CENTAUR,         SK_ARMOUR,         -1),
    ...
    APT(SP_CENTAUR,         SK_SPELLCASTING,   -1),
    APT(SP_CENTAUR,         SK_CONJURATIONS,   -2),
    APT(SP_CENTAUR,         SK_HEXES,          -1),
    APT(SP_CENTAUR,         SK_CHARMS,          1),
    APT(SP_CENTAUR,         SK_SUMMONINGS,     -1),
    APT(SP_CENTAUR,         SK_NECROMANCY,     -2),
    APT(SP_CENTAUR,         SK_TRANSLOCATIONS,  1),
    APT(SP_CENTAUR,         SK_TRANSMUTATIONS, -1),
    APT(SP_CENTAUR,         SK_FIRE_MAGIC,      0),
    APT(SP_CENTAUR,         SK_ICE_MAGIC,      -1),
    APT(SP_CENTAUR,         SK_AIR_MAGIC,       0),
    APT(SP_CENTAUR,         SK_EARTH_MAGIC,     0),
    ...
    APT(SP_DEMIGOD,         SK_INVOCATIONS,     3),
    APT(SP_DEMIGOD,         SK_EVOCATIONS,     -1),

    // SP_SPRIGGAN
    APT(SP_SPRIGGAN,        SK_FIGHTING,       -2),
    APT(SP_SPRIGGAN,        SK_SHORT_BLADES,    2),
    ...
    APT(SP_SPRIGGAN,        SK_BOWS,            0),
    APT(SP_SPRIGGAN,        SK_CROSSBOWS,      -2),
    ...
    APT(SP_SPRIGGAN,        SK_SUMMONINGS,     -3),
    APT(SP_SPRIGGAN,        SK_NECROMANCY,     -1),
    APT(SP_SPRIGGAN,        SK_TRANSLOCATIONS,  4),
    APT(SP_SPRIGGAN,        SK_TRANSMUTATIONS,  3),
    APT(SP_SPRIGGAN,        SK_FIRE_MAGIC,      0),
    APT(SP_SPRIGGAN,        SK_ICE_MAGIC,      -1),
    APT(SP_SPRIGGAN,        SK_AIR_MAGIC,       0),
    ...
    // SP_GHOUL
    APT(SP_GHOUL,           SK_FIGHTING,        2),
    APT(SP_GHOUL,           SK_SHORT_BLADES,   -1),
    APT(SP_GHOUL,           SK_LONG_BLADES,    -1),
    APT(SP_GHOUL,           SK_AXES,            0),
    APT(SP_GHOUL,           SK_MACES_FLAILS,    0),
    APT(SP_GHOUL,           SK_POLEARMS,        0),
    APT(SP_GHOUL,           SK_STAVES,          0),
    APT(SP_GHOUL,           SK_SLINGS,         -2),
    APT(SP_GHOUL,           SK_BOWS,           -1),
    APT(SP_GHOUL,           SK_CROSSBOWS,      -1),
    APT(SP_GHOUL,           SK_THROWING,       -1),
    APT(SP_GHOUL,           SK_ARMOUR,         -1),
    APT(SP_GHOUL,           SK_DODGING,         0),
    APT(SP_GHOUL,           SK_STEALTH,         2),
#if TAG_MAJOR_VERSION == 34
    APT(SP_GHOUL,           SK_STABBING,      UNUSABLE_SKILL),
#endif
    APT(SP_GHOUL,           SK_SHIELDS,        -2),
#if TAG_MAJOR_VERSION == 34
    APT(SP_GHOUL,           SK_TRAPS,         UNUSABLE_SKILL),
#endif
    APT(SP_GHOUL,           SK_UNARMED_COMBAT,  0),
    APT(SP_GHOUL,           SK_SPELLCASTING,    1),
    APT(SP_GHOUL,           SK_CONJURATIONS,   -2),
    APT(SP_GHOUL,           SK_HEXES,           2),
    APT(SP_GHOUL,           SK_CHARMS,         -1),
    APT(SP_GHOUL,           SK_SUMMONINGS,     -2),
    APT(SP_GHOUL,           SK_NECROMANCY,      1),
    APT(SP_GHOUL,           SK_TRANSLOCATIONS, -2),
    APT(SP_GHOUL,           SK_TRANSMUTATIONS, -3),
    APT(SP_GHOUL,           SK_FIRE_MAGIC,     -2),
    APT(SP_GHOUL,           SK_ICE_MAGIC,       0),
    APT(SP_GHOUL,           SK_AIR_MAGIC,      -3),
    ...
    // SP_SKELETON
    APT(SP_SKELETON,           SK_FIGHTING,        0),
    APT(SP_SKELETON,           SK_SHORT_BLADES,    2),
    APT(SP_SKELETON,           SK_LONG_BLADES,     2),
    APT(SP_SKELETON,           SK_AXES,            2),
    APT(SP_SKELETON,           SK_MACES_FLAILS,    2),
    APT(SP_SKELETON,           SK_POLEARMS,        2),
    APT(SP_SKELETON,           SK_STAVES,          2),
    APT(SP_SKELETON,           SK_SLINGS,          2),
    APT(SP_SKELETON,           SK_BOWS,            2),
    APT(SP_SKELETON,           SK_CROSSBOWS,       2),
    APT(SP_SKELETON,           SK_THROWING,       -1),
    ...
    APT(SP_SKELETON,           SK_SPELLCASTING,    3),
    APT(SP_SKELETON,           SK_CONJURATIONS,    2),
    APT(SP_SKELETON,           SK_HEXES,           1),
    APT(SP_SKELETON,           SK_CHARMS,          1),
    APT(SP_SKELETON,           SK_SUMMONINGS,      1),
    APT(SP_SKELETON,           SK_NECROMANCY,      1),
    APT(SP_SKELETON,           SK_TRANSLOCATIONS, -2),
    APT(SP_SKELETON,           SK_TRANSMUTATIONS, UNUSABLE_SKILL),
    APT(SP_SKELETON,           SK_FIRE_MAGIC,      0),
    APT(SP_SKELETON,           SK_ICE_MAGIC,       1),
    APT(SP_SKELETON,           SK_AIR_MAGIC,      -2),
    APT(SP_SKELETON,           SK_EARTH_MAGIC,     0),
    APT(SP_SKELETON,           SK_POISON_MAGIC,    0),
    APT(SP_SKELETON,           SK_INVOCATIONS,    -1),
    APT(SP_SKELETON,           SK_EVOCATIONS,     -1),
    ...
    // SP_ENT
    APT(SP_ENT,      SK_FIGHTING,        1),
    APT(SP_ENT,      SK_SHORT_BLADES,   -2),
    APT(SP_ENT,      SK_LONG_BLADES,    -1),
    APT(SP_ENT,      SK_AXES,           -3),
    APT(SP_ENT,      SK_MACES_FLAILS,    2),
    APT(SP_ENT,      SK_POLEARMS,        1),
    APT(SP_ENT,      SK_STAVES,          0),
    APT(SP_ENT,      SK_SLINGS,         -2),
    APT(SP_ENT,      SK_BOWS,           -1),
    APT(SP_ENT,      SK_CROSSBOWS,      -3),
    APT(SP_ENT,      SK_THROWING,       -2),
    APT(SP_ENT,      SK_ARMOUR, UNUSABLE_SKILL),
    APT(SP_ENT,      SK_DODGING,        -1),
    APT(SP_ENT,      SK_STEALTH,         2),
    #if TAG_MAJOR_VERSION == 34
    APT(SP_ENT,      SK_STABBING,      UNUSABLE_SKILL),
    #endif
    APT(SP_ENT,      SK_SHIELDS,        -2),
    #if TAG_MAJOR_VERSION == 34
    APT(SP_ENT,      SK_TRAPS,         UNUSABLE_SKILL),
    #endif
    APT(SP_ENT,      SK_UNARMED_COMBAT,  0),
    APT(SP_ENT,      SK_SPELLCASTING,    1),
    APT(SP_ENT,      SK_CONJURATIONS,    0),
    APT(SP_ENT,      SK_HEXES,           0),
    APT(SP_ENT,      SK_CHARMS,          0),
    APT(SP_ENT,      SK_SUMMONINGS,     -2),
    APT(SP_ENT,      SK_NECROMANCY, UNUSABLE_SKILL),
    APT(SP_ENT,      SK_TRANSLOCATIONS, -2),
    APT(SP_ENT,      SK_TRANSMUTATIONS,  1),
    APT(SP_ENT,      SK_FIRE_MAGIC,     -1),
    APT(SP_ENT,      SK_ICE_MAGIC,      -1),
    APT(SP_ENT,      SK_AIR_MAGIC,       0),
    APT(SP_ENT,      SK_EARTH_MAGIC,     1),
    APT(SP_ENT,      SK_POISON_MAGIC,    1),
    APT(SP_ENT,      SK_INVOCATIONS,     2),
    APT(SP_ENT,      SK_EVOCATIONS,     -1),

    // SP_FAIRY
    APT(SP_FAIRY,           SK_FIGHTING,       -1),
    APT(SP_FAIRY,           SK_SHORT_BLADES,    0),
    APT(SP_FAIRY,           SK_LONG_BLADES,    -2),
    APT(SP_FAIRY,           SK_AXES,           -2),
    APT(SP_FAIRY,           SK_MACES_FLAILS,   -2),
    APT(SP_FAIRY,           SK_POLEARMS,       -2),
    APT(SP_FAIRY,           SK_STAVES,         -1),
    APT(SP_FAIRY,           SK_SLINGS,         -2),
    APT(SP_FAIRY,           SK_BOWS,           -2),
    APT(SP_FAIRY,           SK_CROSSBOWS,      -3),
...
#endif
    APT(SP_FAIRY,           SK_UNARMED_COMBAT, -1),
    ...
    APT(SP_FAIRY,           SK_NECROMANCY,      0),
    APT(SP_FAIRY,           SK_TRANSLOCATIONS,  1),
    ...
    APT(SP_FELID,           SK_TRANSMUTATIONS,  0),
    ...
    APT(SP_VINE_STALKER,    SK_DODGING,         1),
    ...
    // SP_MANA_STALKER
    APT(SP_MANA_STALKER,    SK_FIGHTING,       -1),
    APT(SP_MANA_STALKER,    SK_SHORT_BLADES,   -1),
    APT(SP_MANA_STALKER,    SK_LONG_BLADES,    -1),
    APT(SP_MANA_STALKER,    SK_AXES,           -1),
    APT(SP_MANA_STALKER,    SK_MACES_FLAILS,   -1),
    APT(SP_MANA_STALKER,    SK_POLEARMS,       -1),
    APT(SP_MANA_STALKER,    SK_STAVES,         -1),
    APT(SP_MANA_STALKER,    SK_SLINGS,         -1),
    APT(SP_MANA_STALKER,    SK_BOWS,           -1),
    APT(SP_MANA_STALKER,    SK_CROSSBOWS,      -1),
    APT(SP_MANA_STALKER,    SK_THROWING,       -1),
    APT(SP_MANA_STALKER,    SK_ARMOUR,         -2),
    APT(SP_MANA_STALKER,    SK_DODGING,         1),
    APT(SP_MANA_STALKER,    SK_STEALTH,         4),
#if TAG_MAJOR_VERSION == 34
    APT(SP_MANA_STALKER,    SK_STABBING,      UNUSABLE_SKILL),
#endif
    APT(SP_MANA_STALKER,    SK_SHIELDS,        -1),
#if TAG_MAJOR_VERSION == 34
    APT(SP_MANA_STALKER,    SK_TRAPS,         UNUSABLE_SKILL),
#endif
    ...
    APT(SP_MANA_STALKER,    SK_NECROMANCY,      0),
    APT(SP_MANA_STALKER,    SK_TRANSLOCATIONS,  0),
    APT(SP_MANA_STALKER,    SK_TRANSMUTATIONS,  0),
    APT(SP_MANA_STALKER,    SK_FIRE_MAGIC,      0),
    APT(SP_MANA_STALKER,    SK_ICE_MAGIC,       0),
    APT(SP_MANA_STALKER,    SK_AIR_MAGIC,       0),
    APT(SP_MANA_STALKER,    SK_EARTH_MAGIC,     0),
    APT(SP_MANA_STALKER,    SK_POISON_MAGIC,    0),
    APT(SP_MANA_STALKER,    SK_INVOCATIONS,     0),
    APT(SP_MANA_STALKER,    SK_EVOCATIONS,     -1),

    // SP_TWILIGHT_STALKER
    APT(SP_TWILIGHT_STALKER,    SK_FIGHTING,       -1),
    APT(SP_TWILIGHT_STALKER,    SK_SHORT_BLADES,   -1),
    APT(SP_TWILIGHT_STALKER,    SK_LONG_BLADES,    -1),
    APT(SP_TWILIGHT_STALKER,    SK_AXES,           -1),
    APT(SP_TWILIGHT_STALKER,    SK_MACES_FLAILS,   -1),
    APT(SP_TWILIGHT_STALKER,    SK_POLEARMS,       -1),
    APT(SP_TWILIGHT_STALKER,    SK_STAVES,         -1),
    APT(SP_TWILIGHT_STALKER,    SK_SLINGS,         -1),
    APT(SP_TWILIGHT_STALKER,    SK_BOWS,           -1),
    APT(SP_TWILIGHT_STALKER,    SK_CROSSBOWS,      -1),
    APT(SP_TWILIGHT_STALKER,    SK_THROWING,       -1),
    APT(SP_TWILIGHT_STALKER,    SK_ARMOUR,         -2),
    APT(SP_TWILIGHT_STALKER,    SK_DODGING,         1),
    APT(SP_TWILIGHT_STALKER,    SK_STEALTH,         4),
#if TAG_MAJOR_VERSION == 34
    APT(SP_TWILIGHT_STALKER,    SK_STABBING,      UNUSABLE_SKILL),
#endif
    APT(SP_TWILIGHT_STALKER,    SK_SHIELDS,        -1),
#if TAG_MAJOR_VERSION == 34
    APT(SP_TWILIGHT_STALKER,    SK_TRAPS,         UNUSABLE_SKILL),
#endif
    APT(SP_TWILIGHT_STALKER,    SK_UNARMED_COMBAT,  0),
    APT(SP_TWILIGHT_STALKER,    SK_SPELLCASTING,    0),
    APT(SP_TWILIGHT_STALKER,    SK_CONJURATIONS,    0),
    APT(SP_TWILIGHT_STALKER,    SK_HEXES,           0),
    APT(SP_TWILIGHT_STALKER,    SK_CHARMS,          0),
    APT(SP_TWILIGHT_STALKER,    SK_SUMMONINGS,      0),
    APT(SP_TWILIGHT_STALKER,    SK_NECROMANCY,      2),
    ...
    APT(SP_TWILIGHT_STALKER,    SK_INVOCATIONS,     0),
    APT(SP_TWILIGHT_STALKER,    SK_EVOCATIONS,     -1),

    // SP_JUNGLE_STALKER
    APT(SP_JUNGLE_STALKER,    SK_FIGHTING,       -1),
    APT(SP_JUNGLE_STALKER,    SK_SHORT_BLADES,   -1),
    APT(SP_JUNGLE_STALKER,    SK_LONG_BLADES,    -1),
    APT(SP_JUNGLE_STALKER,    SK_AXES,           -1),
    APT(SP_JUNGLE_STALKER,    SK_MACES_FLAILS,   -1),
    APT(SP_JUNGLE_STALKER,    SK_POLEARMS,       -1),
    APT(SP_JUNGLE_STALKER,    SK_STAVES,         -1),
    APT(SP_JUNGLE_STALKER,    SK_SLINGS,         -1),
    APT(SP_JUNGLE_STALKER,    SK_BOWS,           -1),
    APT(SP_JUNGLE_STALKER,    SK_CROSSBOWS,      -1),
    APT(SP_JUNGLE_STALKER,    SK_THROWING,       -1),
    APT(SP_JUNGLE_STALKER,    SK_ARMOUR,         -2),
    APT(SP_JUNGLE_STALKER,    SK_DODGING,         1),
    APT(SP_JUNGLE_STALKER,    SK_STEALTH,         4),
#if TAG_MAJOR_VERSION == 34
    APT(SP_JUNGLE_STALKER,    SK_STABBING,      UNUSABLE_SKILL),
#endif
    APT(SP_JUNGLE_STALKER,    SK_SHIELDS,        -1),
#if TAG_MAJOR_VERSION == 34
    APT(SP_JUNGLE_STALKER,    SK_TRAPS,         UNUSABLE_SKILL),
#endif
    APT(SP_JUNGLE_STALKER,    SK_UNARMED_COMBAT,  0),
    APT(SP_JUNGLE_STALKER,    SK_SPELLCASTING,    0),
    APT(SP_JUNGLE_STALKER,    SK_CONJURATIONS,    0),
    APT(SP_JUNGLE_STALKER,    SK_HEXES,           0),
    APT(SP_JUNGLE_STALKER,    SK_CHARMS,          0),
    APT(SP_JUNGLE_STALKER,    SK_SUMMONINGS,      0),
    APT(SP_JUNGLE_STALKER,    SK_NECROMANCY,      0),
    APT(SP_JUNGLE_STALKER,    SK_TRANSLOCATIONS,  0),
    APT(SP_JUNGLE_STALKER,    SK_TRANSMUTATIONS,  0),
