...
{ // Dungeon (OOD cap: 27)
  ...
  {  1,  6,  335, FALL, MONS_DART_SLUG },
  {  1,  8,  515, FALL, MONS_LEOPARD_GECKO },
...
{ // Dis
  ...
  {  1, 12,  270, FLAT, MONS_SKELETON },
  {  1,  3,  136, FALL, MONS_NECROPHAGE },
  {  1,  3,  220, FALL, MONS_MUMMY },
  {  1,  3,   66, FALL, MONS_PHANTOM },
  {  1,  3,  420, FALL, MONS_WIGHT },
  {  1,  4,  475, FALL, MONS_WRAITH },
  {  1,  5,  625, FALL, MONS_SHADOW },
  {  1,  3,  260, FALL, MONS_FLYING_SKULL },
  {  1,  7,  192, FLAT, MONS_FREEZING_WRAITH },
  {  1,  4,  515, FALL, MONS_SKELETAL_WARRIOR },
  {  1,  7,  160, FLAT, MONS_PHANTASMAL_WARRIOR },
  {  1,  7,  136, FLAT, MONS_FLAYED_GHOST },
  {  1,  9,   89, FLAT, MONS_BONE_DRAGON },
  {  1,  7,  180, FLAT, MONS_SILENT_SPECTRE },
  {  1,  7,   25, FLAT, MONS_LICH },
  {  1,  9,   20, FLAT, MONS_ANCIENT_LICH },
  {  1,  5,  440, FALL, MONS_HELL_HOUND },
  {  1,  3,   25, FALL, MONS_HELL_KNIGHT },
  {  1,  7,  500, FLAT, MONS_IRON_IMP },
  {  1,  7, 1000, FLAT, MONS_RUST_DEVIL },
  {  1,  7,  335, FLAT, MONS_ICE_DEVIL },
  {  1,  7,   25, FLAT, MONS_SOUL_EATER },
  {  1,  7,  900, FLAT, MONS_REAPER },
  {  1,  7,  775, FLAT, MONS_TORMENTOR },
  {  1,  7,  300, FLAT, MONS_HELLION },
  {  1,  8,   25, FLAT, MONS_IRON_DRAGON },
  {  1,  4,   60, FLAT, MONS_IRON_GOLEM },
  {  1,  7,   25, FLAT, MONS_DANCING_WEAPON },
...
{ // Cocytus
  ...
  {  0,  4,   70, FALL, MONS_SIMULACRUM },
  {  0,  5,  136, FALL, MONS_PHANTOM },
  {  0,  3,  420, FALL, MONS_WIGHT },
  {  0,  3,  420, FALL, MONS_WRAITH },
  {  0,  3,  625, FALL, MONS_SHADOW },
...
{ // Tartarus
  ...
  {  0,  4,   35, FLAT, MONS_NECROMANCER },
  {  1,  7,  500, FLAT, MONS_SHADOW_IMP },
  {  1,  7,   60, FLAT, MONS_RED_DEVIL },
  {  1,  7,  245, FLAT, MONS_ICE_DEVIL },
  ...
  {  1,  7,   89, FLAT, MONS_SHADOW_DRAGON },
  { 0,0,0,FLAT,MONS_0 }
};
