...
const vector<god_power> god_powers[NUM_GODS] =
{
    ...
    { { 1, "You and your allies can gain power from killing the unholy and evil.",
      ...
      { 2, "The Shining One will gift you ammunition as your piety grows.",
    ...
    { { 1, ABIL_JIYVA_CALL_JELLY, "request a jelly" },
      ...
      { 2, ABIL_JIYVA_STAT_SHUFFLE, "shuffle your attributes" },
    ...
    { { 0, ABIL_ASHENZARI_CURSE, "curse your items" },
      { 1, "The more cursed you are, the more Ashenzari supports your skills.",
           "Ashenzari no longer supports your skills." },
      { 2, ABIL_ASHENZARI_SCRYING, "scry through walls" },
      { 2, "Ashenzari restores your magical power as you explore.",
    ...
    // Dithmenos
    { { 2, ABIL_DITHMENOS_SHADOW_STEP, "step into the shadows of enemies, leaving a shadow behind" },
    ...
    // Qazlal
    {
      ...
      { 5, ABIL_QAZLAL_BECOME_THE_STORM, "become lightning and release nature's wrath" },
    },
    ...
    { { 0, ABIL_HEPLIAKLQANA_RECALL, "recall your ancestor" },
      ...
      { 3, "Hepliaklqana restores your health as you explore.",
           "Hepliaklqana no longer restores your health." },
...
bool is_fellow_slime(const monster& mon)
{
    return mon.alive() && mons_is_slime(mon)
           && (mon.attitude == ATT_STRICT_NEUTRAL || mon.attitude == ATT_FRIENDLY)
