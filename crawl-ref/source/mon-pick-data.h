...
{ // Dungeon (OOD cap: 27)
  {  0,  5,  515, FALL, MONS_GIANT_COCKROACH },
  {  0,  6,  192, FALL, MONS_BALL_PYTHON },
  {  0,  5,  640, FALL, MONS_FRILLED_LIZARD},
  { -1,  7,  136, SEMI, MONS_OOZE },
  {  1,  3, 1000, FALL, MONS_GOBLIN },
  {  1,  3, 1000, FALL, MONS_BAT },
  {  1,  3, 1000, FLAT, MONS_KOBOLD },
  {  1,  3, 1000, FALL, MONS_RAT },
  {  1,  3, 1000, FLAT, MONS_HOBGOBLIN },
  {  1,  5,  335, FALL, MONS_DART_SLUG },
  {  1,  7,  515, FALL, MONS_LEOPARD_GECKO },
  {  1,  9,  335, SEMI, MONS_JACKAL },
  {  2, 11,  192, PEAK, MONS_GNOLL },
  {  2,  8,  515, SEMI, MONS_QUOKKA },
  {  2,  6,  515, FALL, MONS_WORM },
  {  3, 11, 1000, FLAT, MONS_ADDER },
  ...
  {  8, 16,  192, PEAK, MONS_KOMODO_DRAGON },
  ...
  { 11, 17,  825, SEMI, MONS_CYCLOPS },
  { 11, 17,  520, SEMI, MONS_MANTICORE },
...
{ // Lair (OOD cap: 12)
  ...
  {  1,  5,  800, FLAT, MONS_BULLFROG },
  {  1,  6,  900, FLAT, MONS_CROCODILE },
  {  1,  6,  690, FLAT, MONS_WATER_MOCCASIN },
  {  1,  6,  500, FLAT, MONS_HIPPOGRIFF },
  {  1,  6,  515, FLAT, MONS_YAK },
  {  1,  7,  200, PEAK, MONS_WYVERN },
  ...
  {  2,  6,   30, PEAK, MONS_HORNET },
  {  2,  6,   40, FALL, MONS_STEAM_DRAGON },
  {  2,  7,   20, FLAT, MONS_ACID_DRAGON },
  {  2,  7,   25, PEAK, MONS_OKLOB_PLANT },
  {  2,  8,   25, PEAK, MONS_HELL_RAT },
  {  2,  8,  150, SEMI, MONS_POLAR_BEAR },
...
{ // Swamp
  ...
  {  2,  6,   36, RISE, MONS_TENTACLED_MONSTROSITY },
...
{ // Spider Nest
  ...
  {  0,  3,  700, FLAT, MONS_REDBACK },
  {  0,  3,  500, FLAT, MONS_ORB_SPIDER },
  {  0,  5,  100, FLAT, MONS_TORPOR_SNAIL },
  {  0,  5,  100, FLAT, MONS_WORKER_ANT },
  {  0,  5,  190, SEMI, MONS_EMPEROR_SCORPION },
  {  0,  5,  190, SEMI, MONS_ORANGE_STATUE },
...
{ // Slime Pits
  ...
  {  2,  8,   50, SEMI, MONS_EYE_OF_DEVASTATION },
...
{ // Vaults (OOD cap: 12)
  ...
  {  0,  6,  180, FLAT, MONS_VERY_UGLY_THING },
  {  1,  1,  185, FLAT, MONS_WRAITH },
  {  1,  2,  200, FLAT, MONS_CYCLOPS },
  {  1,  3,  136, FLAT, MONS_RAKSHASA },
  {  1,  3,  440, FALL, MONS_SLIME_CREATURE },
  {  1,  3,  500, FLAT, MONS_WIZARD },
  {  1,  3,  100, FLAT, MONS_IRONHEART_BEASTMASTER },
  {  1,  4,  200, FALL, MONS_IRONHEART_BEASTMASTER },
  ...
  {  1, 10,  640, FALL, MONS_IRONHEART_CONVOKER },
  {  1, 11,  575, FALL, MONS_IRONHEART_PRESERVER },
  {  1, 12,  510, FALL, MONS_VAULT_WARDEN },
  {  1, 12,  415, FALL, MONS_YAKTAUR_CAPTAIN },
  {  2, 12,   32, FLAT, MONS_CRYSTAL_GUARDIAN },
  {  2, 12,  340, FALL, MONS_STONE_GIANT },
  {  2, 12,  192, PEAK, MONS_ETTIN },
  {  1,  4,   80, FLAT, MONS_DEEP_ELF_MAGE },
  {  2, 11,  100, FLAT, MONS_FIRE_GIANT },
  {  2, 11,  136, SEMI, MONS_FROST_GIANT },
  {  2, 11,   68, SEMI, MONS_DEEP_TROLL },
  {  3, 11,   66, PEAK, MONS_LICH },
  {  1,  5,   80, FLAT, MONS_ORC_WARLORD },
  {  1, 10,   25, FLAT, MONS_HELL_KNIGHT },
  {  3, 12,  155, PEAK, MONS_TENGU_REAVER },
  {  3, 12,   89, PEAK, MONS_STORM_DRAGON },
  {  2, 12,   80, FLAT, MONS_PHANTASMAL_WARRIOR },
  {  2, 11,   70, FLAT, MONS_WAR_GARGOYLE },
  {  1, 12,   60, FLAT, MONS_DANCING_WEAPON },
  {  3, 13,  100, FLAT, MONS_GLOWING_SHAPESHIFTER },
  {  3, 13,   30, FLAT, MONS_JUGGERNAUT },
  {  3, 13,   50, FLAT, MONS_TENTACLED_MONSTROSITY },
  {  8, 12,   50, FLAT, MONS_SHADOW_DRAGON },
  {  9, 12,   50, FLAT, MONS_TITAN },
  { 10, 12,   25, FLAT, MONS_DEEP_ELF_HIGH_PRIEST },
  { 10, 12,   16, FLAT, MONS_QUICKSILVER_DRAGON },
  { 10, 12,   16, FLAT, MONS_IRON_DRAGON },
  { 10, 14,   25, FLAT, MONS_GOLDEN_DRAGON },
...
{ // Dis
  {  1,  7, 1000, FLAT, MONS_ZOMBIE },
  {  1,  7, 1000, FLAT, MONS_SKELETON },
  {  1,  3,  136, FALL, MONS_NECROPHAGE },
  {  1,  3,  420, FALL, MONS_GHOUL },
  {  1,  3,  260, FALL, MONS_FLYING_SKULL },
  {  1,  3,  515, FALL, MONS_SKELETAL_WARRIOR },
  {  1,  7,  136, FLAT, MONS_FLAYED_GHOST },
  {  1,  7,  200, FLAT, MONS_BONE_DRAGON },
  {  1,  7,  180, FLAT, MONS_SILENT_SPECTRE },
  {  1,  7,  120, FLAT, MONS_LICH },
  {  1,  9,   20, FLAT, MONS_ANCIENT_LICH },
  {  1,  3,  100, FALL, MONS_HELL_KNIGHT },
  {  1,  7,  500, FLAT, MONS_IRON_IMP },
  {  1,  7, 1000, FLAT, MONS_RUST_DEVIL },
  {  1,  7,  900, FLAT, MONS_REAPER },
  {  1,  7,  300, FLAT, MONS_TORMENTOR },
  {  1,  7,  300, FLAT, MONS_HELLION },
  {  1,  7,  150, FLAT, MONS_IRON_DRAGON },
  {  1,  7,  300, FLAT, MONS_IRON_GOLEM },
  {  1,  7,  270, FLAT, MONS_IRON_GIANT },
  {  0,  4,   80, RISE, MONS_HELL_SENTINEL },
  { 0,0,0,FLAT,MONS_0 }
};
...
{ // Gehenna
  ...
  {  1,  3,  300, FALL, MONS_GHOUL },
  {  1,  3,  200, FALL, MONS_EFREET },
  {  1,  3,  300, FALL, MONS_HELL_HOUND },
  {  1,  3,  300, FALL, MONS_RED_DEVIL },
  { -1,  4,  600, FALL, MONS_HELL_KNIGHT },
  {  1,  7,  385, FLAT, MONS_FLYING_SKULL },
  {  1,  7,  215, FLAT, MONS_FLAYED_GHOST },
  {  1,  8,   25, FLAT, MONS_BONE_DRAGON },
  {  1,  9,  120, FLAT, MONS_LICH },
  {  1,  7,  300, FLAT, MONS_HELL_HOG },
  { -1,  7,   89, FLAT, MONS_RUST_DEVIL },
  {  3,  7,    8, FLAT, MONS_SOUL_EATER },
  {  1,  7,  590, FLAT, MONS_HELLION },
  {  1,  7,  200, FLAT, MONS_TORMENTOR },
  {  1,  7,  250, FLAT, MONS_HELLEPHANT },
  {  1,  7,  250, FLAT, MONS_BALRUG },
  {  1,  9,  385, FLAT, MONS_REAPER },
  {  0,  4,   16, RISE, MONS_HELL_SENTINEL },
  {  0,  4,  400, RISE, MONS_BRIMSTONE_FIEND },
  { 0,0,0,FLAT,MONS_0 }
};

static const pop_entry pop_coc[] =
{ // Cocytus
  {  1,  2, 1000, FLAT, MONS_SIMULACRUM },
  {  1,  2, 1000, FLAT, MONS_SPECTRAL_THING },
  {  0,  3,  420, FALL, MONS_GHOUL },
  {  0,  3,  420, FALL, MONS_WRAITH },
  {  1,  7,  970, FLAT, MONS_FREEZING_WRAITH },
  {  1,  7,  640, FLAT, MONS_FLYING_SKULL },
  {  1,  7,  515, FLAT, MONS_SKELETAL_WARRIOR },
  {  1,  7,   89, FLAT, MONS_PHANTASMAL_WARRIOR },
  {  1,  7,   35, FLAT, MONS_BONE_DRAGON },
  {  1,  2,   35, FLAT, MONS_LICH },
  {  1,  2,   15, RISE, MONS_ANCIENT_LICH },
  {  1,  7,  500, FLAT, MONS_WHITE_IMP },
  {  1,  7,  890, FLAT, MONS_ICE_DEVIL },
  {  1,  7,   81, PEAK, MONS_SOUL_EATER },
  {  1,  7,  285, FLAT, MONS_TORMENTOR },
  {  1,  7,  200, FLAT, MONS_ICE_FIEND },
  {  1,  7,  192, FLAT, MONS_BLIZZARD_DEMON },
  {  1,  7,  455, FLAT, MONS_REAPER },
  {  0,  3,  955, FALL, MONS_ICE_BEAST },
  {  1,  7,  305, FLAT, MONS_ICE_DRAGON },
  {  0,  2,  270, RISE, MONS_SHARD_SHRIKE },
  { 0,0,0,FLAT,MONS_0 }
};
...
{ // Tartarus
  ...
  {  1,  3,  550, FALL, MONS_WRAITH },
  {  1,  3,  550, FALL, MONS_PHANTOM },
  {  1,  3,  835, FALL, MONS_GHOUL },
  {  1,  7,  200, FLAT, MONS_VAMPIRE_MAGE },
  {  1,  7,  200, FLAT, MONS_VAMPIRE_KNIGHT },
  {  1,  7,  570, FLAT, MONS_FLYING_SKULL },
  {  1,  7,  690, FLAT, MONS_FREEZING_WRAITH },
  {  1,  7,  500, FLAT, MONS_PHANTASMAL_WARRIOR },
  {  1,  7,  200, FLAT, MONS_FLAYED_GHOST },
  {  1,  7,  300, FLAT, MONS_SILENT_SPECTRE },
  {  1,  7,  334, FLAT, MONS_BONE_DRAGON },
  {  1,  9,  125, FLAT, MONS_LICH },
  {  0,  2,   50, RISE, MONS_ANCIENT_LICH },
  {  1,  7,  500, FLAT, MONS_DOOM_HOUND },
  {  1,  7,   46, FLAT, MONS_HELL_KNIGHT },
  {  0,  4,   35, FLAT, MONS_DEEP_ELF_DEATH_MAGE },
  {  1,  7,  500, FLAT, MONS_SHADOW_IMP },
  {  1,  9,  260, FLAT, MONS_SOUL_EATER },
  {  1,  7,  860, FLAT, MONS_REAPER },
  {  1,  7,  700, FLAT, MONS_TORMENTOR },
  {  1,  7,  500, FLAT, MONS_SHADOW_DEMON },
  {  1,  7,  230, FLAT, MONS_GHOST_CRAB },
  {  1,  7,   80, FLAT, MONS_DEATH_DRAKE },
  {  1,  7,  100, FLAT, MONS_SHADOW_DRAGON },
  {  0,  4,  300, RISE, MONS_SHADOW_FIEND },
  { 0,0,0,FLAT,MONS_0 }
};
...
{ // Zot
  ...
  {  2,  5,   80, FLAT, MONS_EYE_OF_DEVASTATION },
...
{ // Abyss
  ...
  {  2,  5,   10, FLAT, MONS_HELL_SENTINEL },
  ...
  {  1,  8,   35, FLAT, MONS_INSUBSTANTIAL_WISP },
  ...
  {  2,  5,    8, FLAT, MONS_EYE_OF_DEVASTATION },
  ...
  {  2,  5,    3, FLAT, MONS_DRACONIAN_STORMCALLER },
  {  2,  5,    5, FLAT, MONS_DRACONIAN_SHIFTER },
  {  2,  5,    3, FLAT, MONS_DRACONIAN_ANNIHILATOR },
  {  2,  5,    3, FLAT, MONS_DRACONIAN_KNIGHT },
  {  2,  5,    3, FLAT, MONS_DRACONIAN_SCORCHER },
...
{ // Depths (OOD cap: 14)
  ...
  { -2,  6,  100, PEAK, MONS_HELL_KNIGHT },
  { -2,  6,  100, PEAK, MONS_VAMPIRE_KNIGHT },
  {  1,  3,  300, FALL, MONS_WIZARD },
  {  1,  2,  250, FALL, MONS_CENTAUR_WARRIOR },
  {  1,  3,  200, FALL, MONS_OGRE_MAGE },
  ...
  {  1,  8,  120, SEMI, MONS_ROCKSLIME },
  {  1,  8,  100, SEMI, MONS_SPHINX },
  ...
  {  1,  5,   25, SEMI, MONS_DEEP_ELF_DEMONOLOGIST },
  {  1,  5,   25, SEMI, MONS_DEEP_ELF_ANNIHILATOR },
  {  1,  5,   25, SEMI, MONS_DEEP_ELF_SORCERER },
  {  1,  5,   25, SEMI, MONS_DEEP_ELF_DEATH_MAGE },
  {  4, 14,   80, SEMI, MONS_KILLER_KLOWN },
  {  4, 14,   80, SEMI, MONS_TENTACLED_MONSTROSITY },
  {  4, 14,   40, FLAT, MONS_SHADOW_DRAGON },
  {  4, 14,   25, FLAT, MONS_QUICKSILVER_DRAGON },
  {  4, 14,   80, SEMI, MONS_GOLDEN_DRAGON },
  {  4, 14,   50, FLAT, MONS_JUGGERNAUT },
  {  4, 14,   50, FLAT, MONS_CAUSTIC_SHRIKE },
  {  5, 14,   50, FLAT, MONS_TITAN },
  {  9, 14,   40, FLAT, MONS_ANCIENT_LICH },
  { 0,0,0,FLAT,MONS_0 }
};
