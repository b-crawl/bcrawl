...
tileidx_t tileidx_ability(const ability_type ability)
{
    ...
    case ABIL_CANCEL_PIERCE:
        return TILEG_ABILITY_CANCEL_PIERCE;
    ...
    case ABIL_MAKHLEB_HEW:
        return TILEG_ABILITY_MAKHLEB_HEW;
    ...
    case ABIL_SIF_MUNA_MOMENT_OF_MAGIC:
        return TILEG_ABILITY_SIF_MUNA_MOMENT_OF_MAGIC;
    // Trog
    ...
    case ABIL_JIYVA_STAT_SHUFFLE:
        return TILEG_ABILITY_JIYVA_STAT_SHUFFLE;
    ...
    case ABIL_QAZLAL_BECOME_THE_STORM:
        return TILEG_ABILITY_QAZLAL_BECOME_THE_STORM;
    // Ru
