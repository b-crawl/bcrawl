...
static const mon_spellbook mspell_list[] =
{
    ...
    {  MST_DEEP_ELF_ARCHER,
      {
       ...
       { SPELL_BLINK_AWAY, 20, MON_SPELL_WIZARD | MON_SPELL_SHORT_RANGE },
      }
    },
    ...
    {  MST_WATER_NYMPH,
      {
       { SPELL_PRIMAL_WAVE, 40, MON_SPELL_MAGICAL },
    ...
    {  MST_WIZARD_I,
      {
       { SPELL_STONE_ARROW, 44, MON_SPELL_WIZARD },
    ...
    {  MST_WIZARD_II,
      {
       { SPELL_ISKENDERUNS_MYSTIC_BLAST, 44, MON_SPELL_WIZARD },
    ...
    {  MST_WIZARD_III,
      {
       { SPELL_SLOW, 44, MON_SPELL_WIZARD },
    ...
    {  MST_DRACONIAN_SCORCHER,
      {
       { SPELL_BOLT_OF_MAGMA, 50, MON_SPELL_WIZARD },
       { SPELL_FIRE_SUMMON, 15, MON_SPELL_WIZARD },
       { SPELL_HURL_DAMNATION, 20, MON_SPELL_WIZARD },
      }
    },
    ...
    {  MST_EYE_OF_DEVASTATION,
      {
       ...
       { SPELL_BLINK_CLOSE, 100, MON_SPELL_MAGICAL },
      }
    },

    {  MST_SHINING_EYE,
      {
       { SPELL_CORRUPTING_PULSE, 57, MON_SPELL_MAGICAL },
      }
    },

    {  MST_GREAT_ORB_OF_EYES,
      {
       { SPELL_ENERGY_BOLT, 30, MON_SPELL_MAGICAL },
       { SPELL_DISINTEGRATE, 30, MON_SPELL_MAGICAL },
       { SPELL_DRAINING_GAZE, 30, MON_SPELL_MAGICAL },
       { SPELL_CONFUSE, 30, MON_SPELL_MAGICAL },
      }
    },
    ...
    {  MST_HIPPOGRIFF,
      {
       { SPELL_WIND_BLAST, 20, MON_SPELL_MAGICAL | MON_SPELL_INSTANT },
       { SPELL_BECKONING, 20, MON_SPELL_MAGICAL | MON_SPELL_INSTANT },
      }
    },
    ...
    {  MST_LICH_I,
      {
       { SPELL_HASTE, 40, MON_SPELL_WIZARD },
       { SPELL_BOLT_OF_FIRE, 30, MON_SPELL_WIZARD },
       { SPELL_CORROSIVE_BOLT, 30, MON_SPELL_WIZARD },
       { SPELL_POISON_ARROW, 30, MON_SPELL_WIZARD },
       { SPELL_BLINK, 10, MON_SPELL_WIZARD },
      }
    },
    ...
    {  MST_LICH_II,
      {
       { SPELL_HASTE, 40, MON_SPELL_WIZARD },
       { SPELL_FORCE_LANCE, 30, MON_SPELL_WIZARD },
       { SPELL_IOOD, 11, MON_SPELL_WIZARD },
       { SPELL_LIGHTNING_BOLT, 30, MON_SPELL_WIZARD },
      }
    },
    ...
    {  MST_LICH_III,
      {
       ...
       { SPELL_IRON_SHOT, 30, MON_SPELL_WIZARD },
    ...
    {  MST_LICH_IV,
      {
       { SPELL_HAUNT, 30, MON_SPELL_WIZARD },
    ...
    {  MST_LICH_V,
      {
       { SPELL_INVISIBILITY, 25, MON_SPELL_WIZARD },
       { SPELL_BOLT_OF_COLD, 25, MON_SPELL_WIZARD },
       { SPELL_PARALYSE, 30, MON_SPELL_WIZARD },
       { SPELL_BANISHMENT, 15, MON_SPELL_WIZARD },
       { SPELL_BLINK, 10, MON_SPELL_WIZARD },
      }
    },
    ...
    {  MST_GREATER_MUMMY_I,
      {
       ...
       { SPELL_SUMMON_EMPEROR_SCORPIONS, 20, MON_SPELL_WIZARD },
       { SPELL_SUMMON_SCARABS, 20, MON_SPELL_WIZARD },
      }
    },
    ...
    {  MST_GREATER_MUMMY_II,
      {
       { SPELL_SMITING, 13, MON_SPELL_WIZARD },
       { SPELL_SYMBOL_OF_TORMENT, 13, MON_SPELL_WIZARD },
       { SPELL_SUMMON_GREATER_DEMON, 40, MON_SPELL_WIZARD },
      }
    },
    ...
    {  MST_NAGA_MAGE,
      {
       { SPELL_SPIT_POISON, 40, MON_SPELL_NATURAL | MON_SPELL_BREATH },
       { SPELL_ISKENDERUNS_MYSTIC_BLAST, 30, MON_SPELL_WIZARD },
       { SPELL_SPECTRAL_CLOUD, 10, MON_SPELL_WIZARD },
    ...
    {  MST_NAGARAJA,
      {
       { SPELL_SPIT_POISON, 50, MON_SPELL_NATURAL | MON_SPELL_BREATH },
       { SPELL_FIREBALL, 16, MON_SPELL_WIZARD },
       { SPELL_POISON_ARROW, 16, MON_SPELL_WIZARD },
       { SPELL_HASTE, 15, MON_SPELL_WIZARD },
      }
    },
    ...
    {  MST_NAGA_RITUALIST,
      {
       { SPELL_SPIT_POISON, 55, MON_SPELL_NATURAL | MON_SPELL_BREATH },
       { SPELL_SUMMON_MANA_VIPER, 13, MON_SPELL_PRIEST },
       { SPELL_SUMMON_VERMIN, 13, MON_SPELL_PRIEST },
       { SPELL_OLGREBS_TOXIC_RADIANCE, 23, MON_SPELL_PRIEST  },
       { SPELL_VIRULENCE, 23, MON_SPELL_PRIEST },
      }
    },
    ...
    {  MST_SALAMANDER_MYSTIC,
      {
       ...
       { SPELL_BOLT_OF_MAGMA, 20, MON_SPELL_WIZARD },
       { SPELL_HASTE_OTHER, 30, MON_SPELL_WIZARD },
      }
    },
    ...
    {  MST_OGRE_MAGE_I,
      {
       ...
       { SPELL_ENSNARE, 20, MON_SPELL_WIZARD },
       { SPELL_HASTE, 10, MON_SPELL_WIZARD },
      }
    },
    ...
    {  MST_OGRE_MAGE_II,
      {
       { SPELL_POISON_ARROW, 20, MON_SPELL_WIZARD },
       { SPELL_BERSERK_OTHER, 10, MON_SPELL_WIZARD },
       { SPELL_CONFUSE, 10, MON_SPELL_WIZARD },
    ...
    {  MST_TENGU_CONJURER_I,
      {
       { SPELL_ISKENDERUNS_MYSTIC_BLAST, 15, MON_SPELL_WIZARD },
       { SPELL_FORCE_LANCE, 20, MON_SPELL_WIZARD },
       { SPELL_BATTLESPHERE, 20, MON_SPELL_WIZARD },
    ...
    {  MST_TENGU_CONJURER_II,
      {
       { SPELL_LIGHTNING_BOLT, 30, MON_SPELL_WIZARD },
       { SPELL_SPRINT, 20, MON_SPELL_WIZARD },
       { SPELL_BLINK, 10, MON_SPELL_WIZARD | MON_SPELL_EMERGENCY },
      }
    },
    ...
    {  MST_TENGU_CONJURER_III,
      {
       { SPELL_BOLT_OF_FIRE, 25, MON_SPELL_WIZARD },
       { SPELL_FIREBALL, 15, MON_SPELL_WIZARD },
       { SPELL_BLINK, 10, MON_SPELL_WIZARD | MON_SPELL_EMERGENCY },
      }
    },
    ...
    {  MST_NEQOXEC,
      {
       { SPELL_CORRUPTING_PULSE, 19, MON_SPELL_MAGICAL },
    ...
    {  MST_SHADOW_FIEND,
      {
       { SPELL_SHADOW_CREATURES, 25, MON_SPELL_MAGICAL },
    ...
    {  MST_DEMONSPAWN_BLOOD_SAINT,
      {
       ...
       { SPELL_CALL_OF_CHAOS, 20, MON_SPELL_MAGICAL },
      }
    },
    ...
    {  MST_DEMONSPAWN_BLACK_SUN,
      {
       { SPELL_BOLT_OF_DRAINING, 30, MON_SPELL_PRIEST | MON_SPELL_INSTANT },
       { SPELL_DISPEL_UNDEAD, 30, MON_SPELL_PRIEST | MON_SPELL_INSTANT },
       { SPELL_SAP_MAGIC, 30, MON_SPELL_PRIEST | MON_SPELL_INSTANT },
      }
    },
    ...
    {  MST_FANNAR,
      {
       ...
       { SPELL_SUMMON_ICE_BEAST, 25, MON_SPELL_WIZARD },
       { SPELL_FREEZING_CLOUD, 10, MON_SPELL_WIZARD },
       { SPELL_BLINK, 30, MON_SPELL_WIZARD | MON_SPELL_EMERGENCY },
      }
    },
    ...
    { MST_THE_ENCHANTRESS,
      {
       { SPELL_HASTE, 25, MON_SPELL_WIZARD },
       { SPELL_MIGHT_OTHER, 25, MON_SPELL_WIZARD },
       { SPELL_SLOW, 11, MON_SPELL_WIZARD },
    ...
    {  MST_GASTRONOK,
      {
       ...
       { SPELL_SUMMON_MINOR_DEMON, 20, MON_SPELL_WIZARD },
       { SPELL_SUMMON_SMALL_MAMMAL, 15, MON_SPELL_WIZARD },
       { SPELL_SLOW, 10, MON_SPELL_WIZARD },
       { SPELL_SPRINT, 10, MON_SPELL_WIZARD },
      }
    },
    ...
    {  MST_XTAHUA,
      {
       ...
       { SPELL_FIRE_STORM, 20, MON_SPELL_WIZARD },
      }
    },
    ...
    {  MST_BORIS,
      {
       ...
       { SPELL_HAUNT, 16, MON_SPELL_WIZARD },
       { SPELL_IOOD, 16, MON_SPELL_WIZARD },
       { SPELL_INVISIBILITY, 34, MON_SPELL_WIZARD },
      }
    },
    ...
    {  MST_VASHNIA,
      {
       { SPELL_PORTAL_PROJECTILE, 25, MON_SPELL_WIZARD },
       { SPELL_HASTE_OTHER, 50, MON_SPELL_WIZARD },
       { SPELL_BLINK_ALLIES_AWAY, 15, MON_SPELL_WIZARD },
       { SPELL_BLINK_AWAY, 10, MON_SPELL_WIZARD },
      }
    },
    ...
    {  MST_JORY,
      {
       ...
       { SPELL_VAMPIRIC_DRAINING, 30, MON_SPELL_WIZARD },
       { SPELL_BLINK_CLOSE, 10, MON_SPELL_WIZARD },
      }
    },
    ...
    {  MST_ERICA,
      {
       ...
       { SPELL_ISKENDERUNS_MYSTIC_BLAST, 15, MON_SPELL_WIZARD },
       { SPELL_SLOW, 20, MON_SPELL_WIZARD },
       { SPELL_BERSERKER_RAGE, 20, MON_SPELL_WIZARD },
      }
    },
    ...
    {  MST_MAURICE,
      {
       { SPELL_INVISIBILITY, 25, MON_SPELL_WIZARD },
       { SPELL_PORTAL_PROJECTILE, 35, MON_SPELL_WIZARD },
    ...
    {  MST_FRANCES,
      {
       { SPELL_SUMMON_DEMON, 50, MON_SPELL_MAGICAL | MON_SPELL_INSTANT },
      }
    },
    ...
    {  MST_ASMODEUS,
      {
       { SPELL_HASTE, 28, MON_SPELL_MAGICAL },
       { SPELL_BOLT_OF_FIRE, 18, MON_SPELL_MAGICAL },
       { SPELL_HURL_DAMNATION, 18, MON_SPELL_MAGICAL },
       { SPELL_SUMMON_ILLUSION, 18, MON_SPELL_MAGICAL },
       { SPELL_FIRE_SUMMON, 18, MON_SPELL_MAGICAL },
      }
    },
