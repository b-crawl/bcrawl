...

{
    ...
    "orb of energy",
    100,
    new calcdice_calculator<2, 7, 3, 7>,
...

{
    ...
    "bolt of magma",
    200,
    new calcdice_calculator<4, 16, 5, 6>,
...

{
    ...
    "radiant glob",
    50,
    new calcdice_calculator<0, 1, 0, 1>,
    new tohit_calculator<1, 0, 1>,
    new dicedef_calculator<0, 1, 0, 1>,
    new tohit_calculator<2, 0, 1>,
    LIGHTMAGENTA,
    false,
    BEAM_MMISSILE,
    DCHAR_FIRED_ZAP,
...

{
    ...
    "living lightning",
    200,
    new calcdice_calculator<2, 11, 2, 3>,
    new tohit_calculator<AUTOMATIC_HIT>,
