...
static const duration_def duration_data[] =
{
    ...
    { DUR_INCARNATE,
      WHITE, "Inc",
      "incarnating", "",
      "You are channeling your ancestor.", D_EXPIRES,
      {{ "", hep_remove_incarnate }}},
    { DUR_EXHAUSTED,
      YELLOW, "Exh",
      "exhausted", "",
    ...
    { DUR_FIRE_SHIELD,
      BLUE, "Steam",
      "immune to steam clouds", "steam barrier",
      "", D_DISPELLABLE | D_EXPIRES,
      {{ "Your steam barrier gutters out." },
       { "Your steam barrier is guttering out.", 2}}, 5},
    { DUR_ICY_ARMOUR,
      0, "",
      "icy armour", "",
    ...
    { DUR_SONG_OF_SLAYING,
      ...
      {{ "", []()
        {
            if (you.props[SONG_OF_SLAYING_KEY])
            {
                mpr("Your song has ended.");
                you.redraw_armour_class = true;
            }
        }
        },
    ...
    { DUR_FIRE_ARROW,
      BLUE, "Flame",
      "igniting projectiles", "",
      "Your projectiles are infused with flame.", D_DISPELLABLE | D_EXPIRES,
      {{ "You are no longer infusing your projectiles with flame." },
        { "Your fiery infusion is running out." }}, 6},
    { DUR_FLAYED,
      RED, "Flay",
      "flayed", "",
    ...
    { DUR_MOMENT_OF_MAGIC, LIGHTBLUE, "MoM", "", "moment of magic",
      "You can cast a single spell instantly.", D_EXPIRES,
      {{ "Your moment of magic ends." }}},
    ...
    { DUR_MESMERISED, 0, "", "", "mesmerised", "", D_DISPELLABLE,
      {{ "You break out of your daze.", []() { you.clear_beholders(); }},
         {}, true }},
    { DUR_WENDIGO, 0, "", "", "cursed", "", D_DISPELLABLE,
      {{ "Your terrible hunger fades away.",
        []() { you.clear_beholders(); you.duration[DUR_MESMERISED] = 0; }},
        {}, true }},
