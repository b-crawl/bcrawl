...
#### Spell Changes
  ...
  - v1.31.6: Chain Lightning is reworked: it explodes on each hit, can't target the player, has adjusted damage, and can't loop between 2 targets. It also produces less noise.
  - v1.31.6: Tornado is a level 8 Air/Translocations spell, and has adjusted damage.
...
#### Gods
  ...
  - v1.31.6: Nemelex's Foxfire card has a different set of summons, and now always creates some flying allies and an equal number of weaker flying enemies.
...
#### Normal Monsters
  ...
  - v1.31.6: Elemental wellsprings have Summon Water Elementals instead of creating water elementals when they use Primal Wave.
