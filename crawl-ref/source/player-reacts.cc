...
static void _decrement_durations()
{
        ...
        || you.transform_uncancellable)
    {
        ...
        case transformation::spider:
            last_forever = calc_spell_power(SPELL_SPIDER_FORM, true) >= 15;
            break;
        case transformation::ice_beast:
            last_forever = calc_spell_power(SPELL_ICE_FORM, true) >= 25;
            break;
        case transformation::statue:
            last_forever = calc_spell_power(SPELL_STATUE_FORM, true) >= 50;
            break;
        case transformation::dragon:
            last_forever = calc_spell_power(SPELL_DRAGON_FORM, true) >= 75;
            break;
        case transformation::lich:
            last_forever = calc_spell_power(SPELL_NECROMUTATION, true) >= 100;
            break;
        default: break;
        }
