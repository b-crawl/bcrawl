...

{
    ...
    M_NO_SKELETON,
    MR_VUL_POISON,
    10, MONS_WORKER_ANT, MONS_SOLDIER_ANT, MH_NATURAL, 10,
    { {AT_STING, AF_POISON, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    6, 250,
    12, 7, MST_NO_SPELLS, CE_NOXIOUS, S_SILENT,
    I_ANIMAL, HT_LAND, 10, DEFAULT_ENERGY,
...
// centaurs ('c')
{
    ...
    I_HUMAN, HT_LAND, 10, {7, 7, 10,  7, 10, 10, 10, 100},
...

{
    ...
    I_HUMAN, HT_LAND, 10, {7, 7, 10,  6, 10, 10, 10, 100},
    MONUSE_WEAPONS_ARMOUR, SIZE_LARGE, MON_SHAPE_CENTAUR,
...

{
    ...
    I_HUMAN, HT_LAND, 10, MISSILE_ENERGY(7),
...

{
    ...
    11, 495,
    0, 17, MST_DEEP_ELF_KNIGHT, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_BITE, AF_PLAIN, 15}, {AT_CLAW, AF_PLAIN, 5}, {AT_CLAW, AF_PLAIN, 5},
       AT_NO_ATK },
    6, 270,
...

{
    ...
    { {AT_BITE, AF_POISON_SLOW, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    4, 300,
...

{
    ...
    { {AT_BITE, AF_ROT, 18}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    9, 765,
...

{
    ...
    I_HUMAN, HT_AMPHIBIOUS, 10, SWIM_ENERGY(4),
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...
// rotting monsters ('n')
{
    ...
    { {AT_HIT, AF_COLD, 25}, AT_NO_ATK, AT_NO_ATK },
    6, 390,
...
{
    MONS_WENDIGO, 'n', LIGHTGREEN, "wendigo",
    M_NO_ZOMBIE,
    MR_RES_COLD,
    10, MONS_WENDIGO, MONS_WENDIGO, MH_UNDEAD, 60,
    { {AT_CLAW, AF_PLAIN, 25}, {AT_CLAW, AF_PLAIN, 25}, {AT_BITE, AF_WENDIGO, 35}, AT_NO_ATK },
    18, 1000,
    4, 13, MST_NO_SPELLS, CE_NOXIOUS, S_SILENT,
    I_HUMAN, HT_LAND, 13, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_LARGE, MON_SHAPE_HUMANOID,
    {TILEP_MONS_WENDIGO}, TILE_CORPSE_WENDIGO
},
...

{
    ...
    { {AT_HIT, AF_PLAIN, 25}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    13, 715,
    1, 13, MST_VAULT_GUARD, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...
{
    MONS_IRONHEART_CONVOKER, 'p', YELLOW, "ironheart convoker",
    M_WARM_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
    12, MONS_HUMAN, MONS_HUMAN, MH_NATURAL, 40,
    { {AT_HIT, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    9, 495,
    0, 10, MST_IRONHEART_CONVOKER, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_MONS_IRONHEART_CONVOKER}, TILE_ERROR
},
...
{
    MONS_IRONHEART_BEASTMASTER, 'p', BROWN, "ironheart beastmaster",
    M_WARM_BLOOD | M_SPEAKS | M_REQUIRE_BAND,
    MR_NO_FLAGS,
    10, MONS_HUMAN, MONS_HUMAN, MH_NATURAL, 40,
    { {AT_HIT, AF_REACH, 30}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    12, 550,
    1, 14, MST_IRONHEART_BEASTMASTER, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, {8, 8, 5, 10, 10, 10, 10, 100},
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_MONS_IRONHEART_BEASTMASTER}, TILE_ERROR
},
...
// spiders and insects ('s')
{
    ...
    1, 50,
    3, 10, MST_NO_SPELLS, CE_NOXIOUS, S_SILENT,
    I_ANIMAL, HT_LAND, 12, DEFAULT_ENERGY,
...

{
    ...
    M_NO_SKELETON,
    MR_RES_POISON | mrd(MR_RES_FIRE, 2) | MR_RES_ACID,
    13, MONS_SCORPION, MONS_EMPEROR_SCORPION, MH_NATURAL, 60,
    { {AT_STING, AF_POISON, 30}, {AT_CLAW, AF_DRAG, 15},
      {AT_CLAW, AF_PLAIN, 15}, AT_NO_ATK },
    14, 1190,
    20, 12, MST_NO_SPELLS, CE_CLEAN, S_SILENT,
    I_ANIMAL, HT_LAND, 10, DEFAULT_ENERGY,
...

{
    ...
    { {AT_BITE, AF_CONFUSE, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    8, 280,
...

{
    ...
    { {AT_POUNCE, AF_POISON, 34}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    10, 340,
...

{
    ...
    I_ANIMAL, HT_LAND, 16, DEFAULT_ENERGY,
...

{
    ...
    { {AT_HIT, AF_ENSNARE, 18}, {AT_BITE, AF_POISON_STRONG, 18}, AT_NO_ATK, AT_NO_ATK },
    9, 270,
...
// testudines and crocodiles ('t')
{
    ...
    M_COLD_BLOOD,
    MR_NO_FLAGS,
    16, MONS_CROCODILE, MONS_CROCODILE, MH_NATURAL, 20,
    { {AT_BITE, AF_DRAG, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    5, 275,
    4, 10, MST_ALLIGATOR, CE_CLEAN, S_SILENT,
    I_ANIMAL, HT_AMPHIBIOUS, 10, SWIM_ENERGY(6),
    MONUSE_NOTHING, SIZE_LARGE, MON_SHAPE_QUADRUPED,
...

{
    ...
    { {AT_BITE, AF_DRAG, 30}, {AT_TAIL_SLAP, AF_PLAIN, 15}, AT_NO_ATK,
       AT_NO_ATK },
    12, 720,
...

{
    ...
    { {AT_BITE, AF_CHAOTIC, 25}, {AT_CLAW, AF_CHAOTIC, 25}, AT_NO_ATK, AT_NO_ATK },
    8, 520,
...
{
    MONS_INSUBSTANTIAL_WISP, 'v', LIGHTGREY, "will-o'-wisp",
    M_INSUBSTANTIAL | M_FLIES | M_BATTY,
    mrd(MR_RES_ELEC, 3) | mrd(MR_RES_FIRE | MR_RES_COLD, 2),
    8, MONS_INSUBSTANTIAL_WISP, MONS_INSUBSTANTIAL_WISP, MH_NONLIVING, MAG_IMMUNE,
...

{
    ...
    I_ANIMAL, HT_LAND, 7, SPELL_ENERGY(14),
...

{
    ...
    { {AT_STING, AF_POISON_SLOW, 18}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    6, 330,
...

{
    ...
    MR_RES_POISON | MR_RES_COLD | MR_VUL_FIRE,
...

{
    ...
    MR_RES_FIRE | MR_RES_COLD | MR_RES_ELEC,
    15, MONS_FLYING_SKULL, MONS_FLYING_SKULL, MH_UNDEAD, 20,
    { {AT_HIT, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    7, 210,
    10, 17, MST_FLYING_SKULL, CE_NOCORPSE, S_SCREAM,
    I_ANIMAL, HT_LAND, 15, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_TINY, MON_SHAPE_MISC,
...

{
    ...
    60, MONS_CURSE_TOE, MONS_CURSE_TOE, MH_UNDEAD, MAG_IMMUNE,
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    14, 980,
...

{
    ...
    M_WARM_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
    17, MONS_GIANT, MONS_CYCLOPS, MH_NATURAL, 40,
...

{
    ...
    M_WARM_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
    10, MONS_GIANT, MONS_STONE_GIANT, MH_NATURAL, 80,
...

{
    ...
    { {AT_HIT, AF_TRAMPLE, 80}, {AT_HIT, AF_PLAIN, 50}, AT_NO_ATK, AT_NO_ATK },
    20, 2500,
    20, 5, MST_NO_SPELLS, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 15, ATTACK_ENERGY(30),
    MONUSE_OPEN_DOORS, SIZE_GIANT, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_BITE, AF_PLAIN, 40}, {AT_CLAW, AF_PLAIN, 25},
...

{
    ...
    { {AT_BITE, AF_POISON_STRONG, 40}, {AT_CLAW, AF_PLAIN, 20},
...

{
    ...
    { {AT_BITE, AF_DRAIN_XP, 25}, {AT_CLAW, AF_PLAIN, 15},
      {AT_CLAW, AF_PLAIN, 15}, AT_NO_ATK },
    17, 1275,
...

{
    ...
    { {AT_HIT, AF_POISON, 26}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    7, 385,
...

{
    ...
    12, 600,
    15, 8, MST_NO_SPELLS, CE_CLEAN, S_SILENT, // IRL, goliath frogs have no vocals!
    I_ANIMAL, HT_AMPHIBIOUS, 10, {7,  5, 10, 10, 10, 10, 10, 100},
...

{
    ...
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    7, 385,
    3, 1, MST_EYE_OF_DRAINING, CE_NOCORPSE, S_SILENT,
    I_BRAINLESS, HT_LAND, 16, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_MEDIUM, MON_SHAPE_ORB,
...

{
    ...
    I_HUMAN, HT_LAND, 10, SPELL_ENERGY(5),
...

{
    ...
    M_SEE_INVIS | M_FLIES,
    MR_RES_COLD | MR_RES_ELEC,
    60, MONS_FLOATING_EYE, MONS_EYE_OF_DEVASTATION, MH_NATURAL, 100,
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    10, 550,
    12, 1, MST_EYE_OF_DEVASTATION, CE_NOCORPSE, S_SILENT,
    I_BRAINLESS, HT_LAND, 9, SPELL_ENERGY(3),
    MONUSE_NOTHING, SIZE_MEDIUM, MON_SHAPE_ORB,
...
// hybrids ('H')
{
    ...
    { {AT_BITE, AF_PLAIN, 12}, {AT_PECK, AF_PLAIN, 9}, {AT_CLAW, AF_PLAIN, 9},
       AT_NO_ATK },
    8, 435,
    2, 7, MST_HIPPOGRIFF, CE_CLEAN, S_SCREECH,
    I_ANIMAL, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_LARGE, MON_SHAPE_QUADRUPED_WINGED,
...
{
    MONS_GREENWOOD_WITCH, 'H', LIGHTGREEN, "greenwood witch",
    M_SPEAKS | M_WARM_BLOOD | M_SEE_INVIS,
    MR_RES_POISON | MR_RES_NEG,
    10, MONS_GREENWOOD_WITCH, MONS_GREENWOOD_WITCH, MH_NATURAL | MH_EVIL, 100,
    { { AT_HIT, AF_PLAIN, 25 }, { AT_KICK, AF_PLAIN, 25 }, AT_NO_ATK, AT_NO_ATK },
    17, 700,
    5, 15, MST_GREENWOOD_WITCH, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 13, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    { TILEP_MONS_GREENWOOD_WITCH }, TILE_CORPSE_GREENWOOD_WITCH
},
...

{
    ...
    M_SEE_INVIS | M_UNBLINDABLE | M_EAT_DOORS | M_BURROWS,
    MR_RES_ELEC | MR_RES_FIRE | MR_RES_COLD | MR_RES_PETRIFY,
    7, MONS_JELLY, MONS_ROCKSLIME, MH_NONLIVING, 60,
    { {AT_HIT, AF_TRAMPLE, 50}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    20, 1500,
    27, 2, MST_NO_SPELLS, CE_NOCORPSE, S_SILENT,
    I_BRAINLESS, HT_LAND, 20, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_BIG, MON_SHAPE_BLOB,
...

{
    ...
    { {AT_HIT, AF_COLD, 20}, {AT_HIT, AF_COLD, 20} },
    15, 825,
    5, 10, MST_NO_SPELLS, CE_NOCORPSE, S_SILENT,
...

{
    ...
    { {AT_HIT, AF_ROT, 32}, {AT_CONSTRICT, AF_CRUSH, 32}, AT_NO_ATK, AT_NO_ATK },
    11, 495,
    2, 4, MST_NO_SPELLS, CE_NOCORPSE, S_SILENT,
    I_BRAINLESS, HT_LAND, 10, MOVE_ENERGY(6),
    MONUSE_NOTHING, SIZE_SMALL, MON_SHAPE_BLOB,
...

{
    ...
    { {AT_TOUCH, AF_DRAIN_XP, 25}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    27, 1080,
...
// nagas ('N')
{
    ...
    I_HUMAN, HT_AMPHIBIOUS, 10, MOVE_ENERGY(14),
...

{
    ...
    { {AT_HIT, AF_PLAIN, 27}, {AT_CONSTRICT, AF_CRUSH, 7},
       AT_NO_ATK, AT_NO_ATK },
    15, 825,
    6, 10, MST_NAGARAJA, CE_NOXIOUS, S_SHOUT,
    I_HUMAN, HT_AMPHIBIOUS, 10, MOVE_ENERGY(14),
    MONUSE_WEAPONS_ARMOUR, SIZE_LARGE, MON_SHAPE_NAGA,
...

{
    ...
    { {AT_BITE, AF_POISON_STRONG, 26}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    10, 650,
    2, 20, MST_NO_SPELLS, CE_NOXIOUS, S_HISS,
    I_ANIMAL, HT_AMPHIBIOUS, 15, SWIM_ENERGY(5),
    MONUSE_NOTHING, SIZE_MEDIUM, MON_SHAPE_SNAKE,
...

{
    ...
    MR_RES_POISON | mrd(MR_RES_ELEC, 3),
...

{
    ...
    { {AT_BITE, AF_PLAIN, 40}, {AT_CLAW, AF_PLAIN, 30},
      {AT_CLAW, AF_PLAIN, 30}, AT_NO_ATK },
    16, 880,
...

{
    ...
    { {AT_BITE, AF_PLAIN, 30}, {AT_CLAW, AF_PLAIN, 22},
      {AT_CLAW, AF_PLAIN, 22}, AT_NO_ATK },
    10, 700,
    10, 10, MST_NO_SPELLS, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_LARGE, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_BITE, AF_PLAIN, 27}, {AT_CLAW, AF_PLAIN, 20},
      {AT_CLAW, AF_PLAIN, 20}, AT_NO_ATK },
    12, 480,
    8, 10, MST_DEEP_TROLL_SHAMAN, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_LARGE, MON_SHAPE_HUMANOID,
...
{
    MONS_FALSE_IMAGE, '@', WHITE, "false image",
    M_INSUBSTANTIAL | M_NO_POLY_TO | M_FLIES,
    mrd(MR_RES_FIRE | MR_RES_COLD, 2) | mrd(MR_RES_ELEC, 3) | MR_RES_PETRIFY,
    10, MONS_FALSE_IMAGE, MONS_FALSE_IMAGE, MH_NONLIVING, MAG_IMMUNE,
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    3, 210,
    0, 10, MST_NO_SPELLS, CE_NOCORPSE, S_SILENT,
    I_BRAINLESS, HT_LAND, 0, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_PLAYER}, TILE_ERROR
},
...

{
    ...
    { {AT_HIT, AF_DRAIN_XP, 35}, {AT_HIT, AF_DRAIN_STAT, 16}, AT_NO_ATK,
       AT_NO_ATK },
    13, 715,
...

{
    ...
    9, 495,
    12, 10, MST_BLINK_CLOSE, CE_NOCORPSE, S_SILENT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 45}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    15, 825,
    13, 13, MST_ORB_GUARDIAN, CE_NOCORPSE, S_SILENT,
...

{
    ...
    { {AT_BITE, AF_FIRE, 45}, {AT_GORE, AF_DISTORT, 25},
      {AT_TRAMPLE, AF_TRAMPLE, 25}, AT_NO_ATK },
    20, 1700,
...

{
    ...
    13, MONS_ICE_BEAST, MONS_ICE_BEAST, MH_NATURAL, 100,
...
// demonspawn and oni ('6')
{
    MONS_ONI, '6', LIGHTRED, "oni",
    M_WARM_BLOOD | M_SPEAKS | M_NO_POLY_TO,
    MR_NO_FLAGS,
    10, MONS_ONI, MONS_ONI, MH_NATURAL | MH_DEMONIC, 60,
    { {AT_HIT, AF_PLAIN, 6}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    3, 180,
    0, 10, MST_NO_SPELLS, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
...

{
    ...
    MR_NO_FLAGS,
    10, MONS_DEMONSPAWN, MONS_DEMONSPAWN, MH_NATURAL | MH_DEMONIC, 60,
    { {AT_HIT, AF_SUMMON, 40}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    15, 600,
    0, 2, MST_NO_SPELLS, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    MR_NO_FLAGS,
    10, MONS_DEMONSPAWN, MONS_DEMONSPAWN, MH_NATURAL | MH_DEMONIC, 60,
    { {AT_HIT, AF_DRAIN_XP, 30}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    15, 375,
...
// minor demons: imps, etc. ('5')
{
    ...
    { {AT_HIT, AF_BLINK, 4}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    3, 135,
    3, 14, MST_CRIMSON_IMP, CE_NOCORPSE, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
...

{
    ...
    1, 70,
    2, 15, MST_BLINK_CLOSE, CE_NOCORPSE, S_SHOUT,
    I_HUMAN, HT_LAND, 15, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_SUMMON, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    7, 315,
    7, 13, MST_NO_SPELLS, CE_NOCORPSE, S_SILENT,
    I_HUMAN, HT_LAND, 10, ATTACK_ENERGY(8),
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM,
        MON_SHAPE_HUMANOID_WINGED,
...

{
    ...
    { {AT_HIT, AF_SWOOP, 10}, {AT_HIT, AF_BLINK_WITH, 17}, AT_NO_ATK, AT_NO_ATK },
    7, 455,
...

{
    ...
    M_INSUBSTANTIAL | M_SEE_INVIS | M_FLIES,
...

{
    ...
    { {AT_HIT, AF_POISON_STRONG, 32}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    13, 715,
...

{
    ...
    { {AT_HIT, AF_COLD, 25}, {AT_HIT, AF_COLD, 25}, AT_NO_ATK, AT_NO_ATK },
    12, 660,
...

{
    ...
    { {AT_HIT, AF_FIRE, 60}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    14, 770,
...

{
    ...
    { {AT_HIT, AF_CORRODE, 30}, {AT_HIT, AF_CORRODE, 30}, AT_NO_ATK, AT_NO_ATK },
    13, 975,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 45}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    14, 770,
    15, 10, MST_VAULT_WARDEN, CE_NOCORPSE, S_SILENT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_STARTING_EQUIPMENT, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...
// fiends, etc. ('1')
{
    ...
    { {AT_HIT, AF_PLAIN, 40}, {AT_HIT, AF_PLAIN, 15}, {AT_HIT, AF_PLAIN, 15},
       AT_NO_ATK },
    18, 990,
...

{
    ...
    13, MONS_SHADOW_FIEND, MONS_SHADOW_FIEND, MH_DEMONIC, MAG_IMMUNE,
    { {AT_ENGULF, AF_DRAIN_SPEED, 25}, {AT_BITE, AF_ROT, 25},
      AT_NO_ATK, AT_NO_ATK },
    22, 1050,
    12, 16, MST_SHADOW_FIEND, CE_NOCORPSE, S_ROAR,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_LARGE, MON_SHAPE_HUMANOID,
    {TILEP_MONS_SHADOW_FIEND}, TILE_ERROR
},
...
{
    MONS_ORB_DEMON, '1', LIGHTBLUE, "Orb Demon",
    M_FIGHTER | M_SEE_INVIS,
    MR_RES_ELEC | MR_RES_FIRE | MR_RES_POISON,
    15, MONS_ORB_DEMON, MONS_ORB_DEMON, MH_DEMONIC, 140,
    { {AT_HIT, AF_BLINK, 20}, {AT_HIT, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK },
    17, 1500,
    10, 15, MST_ORB_DEMON, CE_NOCORPSE, S_SCREAM,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_LARGE, MON_SHAPE_HUMANOID,
    {TILEP_MONS_ORB_DEMON}, TILE_ERROR
},
...

{
    ...
    15, 1350,
    20, 3, MST_IRON_GOLEM, CE_NOCORPSE, S_SILENT,
    I_BRAINLESS, HT_LAND, 10,  {14, 14, 10, 10, 30, 10, 10, 100},
    MONUSE_OPEN_DOORS, SIZE_LARGE, MON_SHAPE_HUMANOID,
    {TILEP_MONS_IRON_GOLEM}, TILE_ERROR
},

{
    MONS_ANCIENT_AUTOMATON, '9', LIGHTGREY, "ancient automaton",
    M_NO_FLAGS,
    mrd(MR_RES_ACID, 3),
    10, MONS_GOLEM, MONS_ANCIENT_AUTOMATON, MH_NONLIVING, MAG_IMMUNE,
    { {AT_HIT, AF_TRAMPLE, 55}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    13, 700,
    24, 4, MST_ANCIENT_AUTOMATON, CE_NOCORPSE, S_SILENT,
    I_BRAINLESS, HT_LAND, 9, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_BIG, MON_SHAPE_HUMANOID,
    {TILEP_MONS_IRON_ELEMENTAL}, TILE_ERROR
},
...

{
    ...
    { {AT_HIT, AF_BLINK_WITH, 35}, {AT_HIT, AF_ELEC, 35}, AT_NO_ATK, AT_NO_ATK },
    15, 1350,
...

{
    ...
    MR_RES_ELEC | MR_RES_FIRE | MR_RES_COLD | MR_RES_PETRIFY,
    18, MONS_GARGOYLE, MONS_WAR_GARGOYLE, MH_NONLIVING, 120,
    { {AT_HIT, AF_PLAIN, 50}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    13, 520,
    28, 4, MST_NO_SPELLS, CE_NOCORPSE, S_SILENT,
    I_HUMAN, HT_LAND, 14, DEFAULT_ENERGY,
...

{
    ...
    M_SEE_INVIS | M_INSUBSTANTIAL | M_FLIES,
    MR_RES_ELEC | MR_RES_FIRE | MR_RES_COLD,
    13, MONS_WRETCHED_STAR, MONS_WRETCHED_STAR, MH_NONLIVING, 30,
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    10, 700,
...
//  "a"ncients.
{
    ...
    { {AT_HIT, AF_PLAIN, 35}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    18, 1600,
    15, 13, MST_ZENATA, CE_CLEAN, S_SHOUT,
...

{
    ...
    mrd(MR_RES_ELEC, 3) | mrd(MR_RES_COLD, 2) | MR_VUL_FIRE | MR_RES_POISON,
...
// "d"raconians.
{
    ...
    M_UNIQUE | M_SEE_INVIS | M_SPEAKS | M_FEMALE | M_FLIES,
    MR_RES_POISON | MR_RES_ROTTING,
    ...
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_GIANT, // bigtile!
        MON_SHAPE_HUMANOID_WINGED_TAILED,
    {TILEP_MONS_PROGRAM_BUG}, TILE_ERROR
},
...
// "D"ragons and hydras.
{
    ...
    { {AT_BITE, AF_FIRE, 40}, {AT_CLAW, AF_PLAIN, 25},
      {AT_TRAMPLE, AF_TRAMPLE, 20}, AT_NO_ATK },
    20, 2200,
...
// "H"ybrids.
{
    ...
    { {AT_HIT, AF_ENSNARE, 30},  {AT_KICK, AF_ENSNARE, 25}, AT_NO_ATK, AT_NO_ATK },
    17, 2040,
...
// Spr"i"ggans.
{
    ...
    { {AT_HIT, AF_PLAIN, 30}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    11, 990,
    0, 30, MST_NO_SPELLS, CE_CLEAN, S_SHOUT,
...

{
    ...
    M_WARM_BLOOD | M_SPEAKS | M_SEE_INVIS | M_UNIQUE | M_FEMALE | M_ALWAYS_WAND,
    MR_NO_FLAGS,
...
// "K"obolds.
{
    ...
    M_UNIQUE | M_WARM_BLOOD | M_SPEAKS | M_FEMALE,
    MR_NO_FLAGS,
    40, MONS_KOBOLD, MONS_KOBOLD, MH_NATURAL, 30,
    { {AT_HIT, AF_PLAIN, 12}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    6, 450,
...
// "N"agas.
{
    ...
    M_SEE_INVIS | M_WARM_BLOOD | M_FEMALE
        | M_ARCHER | M_DONT_MELEE | M_SPEAKS | M_UNIQUE | M_ALWAYS_WAND,
    MR_RES_POISON,
    ...
    I_HUMAN, HT_LAND, 10, {14, 14, 10, 10, 5, 10, 10, 100},
    MONUSE_WEAPONS_ARMOUR, SIZE_LARGE, MON_SHAPE_NAGA,
...

{
    ...
    M_UNIQUE | M_FIGHTER | M_WARM_BLOOD | M_SPEAKS | M_FEMALE,
    MR_NO_FLAGS,
    14, MONS_ORC, MONS_ORC, MH_NATURAL, 60,
    { {AT_HIT, AF_PLAIN, 30}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    12, 700,
...
// Semi-unique in the moon base wizlab
{
    ...
    M_WARM_BLOOD | M_SPEAKS | M_FAST_REGEN | M_SEE_INVIS
        | M_NO_POLY_TO | M_NO_GEN_DERIVED,
    MR_RES_FIRE | MR_RES_COLD | MR_RES_POISON | MR_RES_ACID,
    10, MONS_TROLL, MONS_MOON_TROLL, MH_NATURAL, 140,
    { {AT_BITE, AF_ACID, 40}, {AT_CLAW, AF_ACID, 30},
      {AT_CLAW, AF_ACID, 30}, AT_NO_ATK },
    18, 1800,
    20, 6, MST_NO_SPELLS, CE_NOCORPSE, S_SHOUT,
...
// Snails and other gastropods.
{
    ...
    I_HUMAN, HT_AMPHIBIOUS, 10, {15, 15, 10, 10, 5, 10, 10, 100},
...

{
    ...
    M_UNIQUE | M_WARM_BLOOD | M_SPEAKS | M_FEMALE,
    MR_NO_FLAGS,
    30, MONS_HUMAN, MONS_HUMAN, MH_NATURAL, 40,
    { {AT_HIT, AF_PLAIN, 7}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    7, 520,
    0, 12, MST_PSYCHE, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 12, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 40}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    16, 1600,
    12, 10, MST_FRANCES, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 27}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    21, 1575,
    0, 13, MST_FREDERICK, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 30}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    22, 1650,
    4, 14, MST_MARGERY, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_SHADOWSTAB, 10}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    4, 600,
...
// unique major demons ('&')
{
    ...
    { {AT_RANDOM, AF_CORRODE, 43}, {AT_TENTACLE_SLAP, AF_MUTATE, 35},
      {AT_KICK, AF_BLINK, 32}, AT_NO_ATK },
    17, 3820,
