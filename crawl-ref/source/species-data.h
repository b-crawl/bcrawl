...
{ SP_DJINNI, {
    ...
    { {MUT_DJINN_FLIGHT, 1, 1}, {MUT_MP_WANDS, 1, 1}, 
      ...
      {MUT_WILD_MAGIC, 1, 1}, {MUT_WILD_MAGIC, 1, 4}, {MUT_WILD_MAGIC, 1, 10}, 
      {MUT_ANTI_WIZARDRY, 1, 6}, {MUT_HEAT_RESISTANCE, 1, 6}, {MUT_HIGH_MAGIC, 2, 6}, 
...
{ SP_FORMICID, {
    ...
    { JOB_FIGHTER, JOB_HUNTER, JOB_ABYSSAL_KNIGHT, JOB_ARCANE_MARKSMAN,
      JOB_EARTH_ELEMENTALIST, JOB_VENOM_MAGE, JOB_ARCHAEOLOGIST },
    { SK_MACES_FLAILS, SK_AXES, SK_POLEARMS, SK_LONG_BLADES, SK_STAVES,
...
{ SP_GARGOYLE, {
    ...
    { JOB_FIGHTER, JOB_GLADIATOR, JOB_MONK, JOB_BERSERKER, JOB_CONJURER,
      ...
      JOB_VENOM_MAGE, JOB_REAVER, JOB_ARCHAEOLOGIST },
...
{ SP_HILL_ORC, {
    ...
    JOB_FIRE_ELEMENTALIST, JOB_EARTH_ELEMENTALIST, JOB_ARCHAEOLOGIST },
    { SK_MACES_FLAILS, SK_AXES, SK_POLEARMS, SK_LONG_BLADES, SK_STAVES },
} },
...
{ SP_HUMAN, {
    ...
    { JOB_FIGHTER, JOB_GLADIATOR, JOB_BERSERKER, JOB_CONJURER, JOB_SUMMONER,
      ...
      JOB_AIR_ELEMENTALIST, JOB_NECROMANCER, JOB_REAVER, JOB_ASSASSIN, JOB_WANDERER, JOB_ARCHAEOLOGIST },
    { SK_MACES_FLAILS, SK_AXES, SK_POLEARMS, SK_LONG_BLADES, SK_STAVES,
      SK_BOWS, SK_CROSSBOWS, SK_SLINGS },
} },
...
{ SP_SAND_DWARF, {
    ...
    { JOB_FIGHTER, JOB_GLADIATOR, JOB_HUNTER, JOB_BERSERKER,
      JOB_SKALD, JOB_EARTH_ELEMENTALIST, JOB_ASSASSIN },
...
{ SP_SKELETON, {
    ...
    { "You do not eat or drink." },
    { "no food or potions" },
    { JOB_FIGHTER, JOB_GLADIATOR, JOB_MONK, JOB_HUNTER, JOB_SKALD, JOB_WIZARD, JOB_CONJURER, JOB_NECROMANCER, JOB_ICE_ELEMENTALIST, JOB_FIRE_ELEMENTALIST, JOB_SUMMONER, JOB_REAVER },
...
{ SP_SPRIGGAN, {
    ...
    {},
    {},
    { JOB_ASSASSIN, JOB_ARCANE_MARKSMAN, JOB_ENCHANTER,
...
{ SP_VAMPIRE, {
    ...
    JOB_EARTH_ELEMENTALIST, JOB_SUMMONER },
